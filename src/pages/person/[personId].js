...
export default function PeopleDetail(props) {
  ...
  const [people, setPeople] = useState(props.starWarsPeople[personId] ?? persons[personId]);
...
function getAllStarwarsPeople() {
  ...
  return axios("https://swapi.dev/api/people/")
    ...
    .then((count) => {
      ...
      console.log("numberOfPagesLeft", numberOfPagesLeft);
      let promises = [];
